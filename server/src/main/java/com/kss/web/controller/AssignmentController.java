...
public class AssignmentController {
	...
	@ResponseBody
	public String publishAssignment(@RequestBody String assignmentStr) throws Exception{
		Assignment assignment = (Assignment) JsonUtil.buildObjectFromJson(assignmentStr, Assignment.class);
		return JsonUtil.buildJsonFromObject(assignmentService.publishAssignment(assignment));
	}
